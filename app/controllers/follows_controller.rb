class FollowsController < ApplicationController
  ...
  def create
    ...
    flash[:notice] = t("shared.followable.#{followable_translation_key(@follow.followable)}.create.notice_html")
    redirect_to url_for(@follow.followable)
  end
  ...
  def destroy
    ...
    #render :refresh_follow_button
    flash[:notice] = t("shared.followable.#{followable_translation_key(@follow.followable)}.destroy.notice_html")
    redirect_to url_for(@follow.followable)
  end
