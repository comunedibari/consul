class Poll::Question < ActiveRecord::Base
  ...
  has_many :poll_question, class_name: ' Poll::Question', foreign_key: 'question_optional_id'
  ...
  belongs_to :poll_answer, class_name: 'Poll::Answer', foreign_key: 'poll_answer_id'
