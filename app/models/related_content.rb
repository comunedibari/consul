class RelatedContent < ActiveRecord::Base
  RELATED_CONTENT_SCORE_THRESHOLD = Setting['related_content_score_threshold',User.pon_id].to_f
  #RELATIONABLE_MODELS = %w{proposals crowdfundings reportings debates budgets investments}.freeze #miaaa
  RELATIONABLE_PATH = %w{petizioni crowdfundings segnalazioni discussioni }.freeze #miaaa
  RELATIONABLE_MODELS = {"petizioni" => "proposals", "crowdfundings" => "crowdfundings", "segnalazioni" => "reportings", "discussioni" => "debates"}
