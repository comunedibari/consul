...
Rails.application.config.assets.precompile += %w( application_v2.css )
Rails.application.config.assets.precompile += %w( application_v2.js )
Rails.application.config.assets.precompile += %w( process_typology_filters.js )
Rails.application.config.assets.precompile += [ Rails.application.config.css ]
