Rails.application.configure do
  ...
  config.active_record.logger = Logger.new(File.join(Rails.root, 'log', 'active_record.log'))
  ...
  config.action_mailer.default_url_options = {protocol: 'http', host: Rails.application.secrets.server_name}
